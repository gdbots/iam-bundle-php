...
class CognitoJwtAuthenticator implements SimplePreAuthenticatorInterface, AuthenticationFailureHandlerInterface
{
    /** @var CognitoJwtDecoder */
    protected $decoder;

    /**
     * @param CognitoJwtDecoder $decoder
     */
    public function __construct(CognitoJwtDecoder $decoder)
    {
