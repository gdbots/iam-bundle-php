...
class CognitoUserProvider implements JwtUserProvider
{
    /** @var Pbjx */
    protected $pbjx;
    ...
    {
        $ctxUserRef = strpos($jwt->username, 'tmz:iam:node:user:') === false ? 'tmz:iam:node:user:' . $jwt->username : $jwt->username;
